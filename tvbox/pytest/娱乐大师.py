...
id9 = ['4k/4k.php', 'djxjj/dj1.php', 'zj/jipinyz/jipinyz.php', 'zj/xuejie/xuejie.php', 'zj/kawayi/kawayi.php',
...
name9 = ['随机', 'DJ姐姐', '极品钰足', '学姐系列', '卡哇伊', '嫩嫩系列', '美女舞蹈', '丝滑舞蹈', '完美身材',
                '慢摇系列', '丝滑吊带', '清纯系列', 'COS系列', '精品变装', '极品罗丽', '你的裕梦', '甜妹系列',
                '御丝系列', '帅哥哥', '热舞系列', '精品收藏']
pic9 = ['https://img0.baidu.com/it/u=2236794495,926227820&fm=253&fmt=auto&app=138&f=JPEG?w=1091&h=500',
...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result['class'] = []
        result['class'].append({'type_id': '1', 'type_name': 'NO.1'})
