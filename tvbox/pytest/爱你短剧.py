...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "fenle", "type_name": "集多穿越🌠"},
                            {"type_id": "fenlei2", "type_name": "集多战神🌠"},
                            {"type_id": "fenlei3", "type_name": "集多重生🌠"},
                            {"type_id": "fenlei4", "type_name": "集多爱情🌠"},
                            {"type_id": "guda", "type_name": "集多萌娃🌠"},
                            {"type_id": "shenyi", "type_name": "集多神医🌠"},
                            {"type_id": "gudai", "type_name": "集多古代🌠"},
                            {"type_id": "xuanhuan", "type_name": "集多玄幻🌠"},
                            {"type_id": "yanqing", "type_name": "集多言情🌠"}]
                 }
    ...
    def detailContent(self, ids):
        ...
        content = '😸集多🎉为您介绍剧情📢本资源来源于网络🚓侵权请联系删除👉' + self.extract_middle_text(res,'<meta name="description" content="','【爱你短剧】', 0)
